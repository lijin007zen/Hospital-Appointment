...
.dropdown:hover .dropdown-content {
   ...
   <tr>
      ...
      <td width="168"><div align="center" class="style3 style19 style21"><strong>Appointment</strong></div></td>
       <td width="168"><div align="center" class="style3 style19 style21"><strong>Subdate</strong></div></td>
        <td width="168"><div align="center" class="style3 style19 style21"><strong>Specialist</strong></div></td>
    </tr>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from token where hospital = '"+so.getAttribute("un3")+"' and specialist ='"+so.getAttribute("un4")+"'  and dor='"+dateNow+"' and conform=''");
		if(rs!=null)
			{%>
    ...
    <tr>
      ...
      <td width="89"><div align="center"><%=rs.getString(2)%></div></td>
      <td width="120"><div align="center"><%=a12%></div></td>
        <td width="84"><div align="center"><%=a13%></div></td>
      <td width="110"><div align="center"><%=rs.getString(7)%></div></td>
      <td width="108"><div align="center"><%=rs.getString(11)%></div></td>
